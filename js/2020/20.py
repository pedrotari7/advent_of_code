...
tile_transformations = {tileid: build_tile_transformations(
    tile) for tileid, tile in tiles.items()}
tile_matrix = assemble_tiles(tile_transformations)

print(
    f'Part 1: {part1(tile_matrix)}, Part 2: {part2(tile_matrix, tile_transformations)}')
